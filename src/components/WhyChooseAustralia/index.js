...
export const WhyChooseAustralia = ({ setPanel }) => {
  return (
    <div className='flex flex-col items-start justify-start p-[20px] mx-[150px] sm:mx-[50px] md:mx-[50px]'>
      <Img
      ...
      <Text
        className="font-manrope mt-[25px] text-bluegray_900 text-center tracking-ls057 md:tracking-ls1 sm:tracking-ls1 w-[auto]"
        as="h13"
        variant="h13"
      >
